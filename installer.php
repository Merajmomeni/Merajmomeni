...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Website_Files_shop_b83130c45a6aad5d8196_20230418101813_archive.zip';
        const ARCHIVE_SIZE       = '72013938';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'b83130c-18101813';
        const SECONDARY_PACKAGE_HASH = '1cc7cb1-18101813';
        const VERSION            = '1.5.0';
